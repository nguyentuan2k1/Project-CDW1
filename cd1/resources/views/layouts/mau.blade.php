...
<body>
    <div id="wrapper">
        ...
        <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/manage') }}"><i class="fas fa-home"></i> Quản Lý</a>
                <a class="navbar-brand" href="{{ url('/product') }}"><i class="fas fa-paw"></i> Shop</a>
            </div>
            <!-- /.navbar-header -->
            @if(Route::has('login'))
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               ...
                               @foreach($categories as $item)
                                <li>
                                    <a href="{{route('category.view',$item->id)}}">{{$item->category_name}}</a>
                                </li>
                               @endforeach
                            </ul>
                        </li>
